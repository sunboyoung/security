                ...
                <li class="layui-timeline-item">
                    ...
                    <div class="layui-timeline-content layui-text">
                        ...
                        <ul>
                            <li>交流群:
                                <a target="_blank"
                                   href="//shang.qq.com/wpa/qunwpa?idkey=7d46b4a74805131378febabe99963fdd3e767544a34f9b92a9db0737ebf130a1"><img
                                        border="0" src="//pub.idqqimg.com/wpa/images/group.png" alt="BeginnerAdmin"
                                        title="BeginnerAdmin"></a>
                            </li>
                ...
                <li class="layui-timeline-item">
                    ...
                    <div class="layui-timeline-content layui-text">
                        ...
                        <ul>
                            ...
                            <li>更新到 layui 2.1.1 <a href="http://www.layui.com/doc/base/changelog.html" target="_blank">#更新文档</a>
                            </li>
                        </ul>
                        </p>
                    </div>
...
$(selector).on('click',function(){
    message.show({
        ...
        msg:'提示信息'//提示信息
                        ...
                        <input type="button" class="layui-btn" value="点击我测试message组件" id="test"/>
                </li>
                <li>tab组件添加两个属性：<span class="major">closeBefore</span>[关闭选项卡之前发生]、<span class="major">onSwitch</span>[选项卡切换时发生](具体请查看文档[好像文档还没加进去~~~])
                </li>
            </ul>
            </p>
        </div>
